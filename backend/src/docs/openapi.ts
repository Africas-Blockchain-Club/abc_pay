...
// --- Ramp Schemas ---
export const QuoteRequestSchema = registry.register(
  "QuoteRequest",
  z.object({
...
export const OnrampRequestSchema = registry.register(
  "OnrampRequest",
  z.object({
...
export const OnrampResponseSchema = registry.register(
  "OnrampResponse",
  z.object({
...
export const BankDetailsSchema = registry.register(
  "BankDetails",
  z.object({
...
export const OfframpRequestSchema = registry.register(
  "OfframpRequest",
  z.object({
...
export const OfframpResponseSchema = registry.register(
  "OfframpResponse",
  z.object({
    orderId: z.string().uuid(),
...
export const RampOrderRecordSchema = registry.register(
  "RampOrderRecord",
  z.object({
    id: z.string().uuid(),
...
registry.registerPath({
  ...
  description:
    "Fetches real-time price from VALR exchange and applies 2% ABC Pay platform fee",
  request: {
    body: {
...
registry.registerPath({
  ...
  description:
    "Creates on-ramp order, generates unique payment reference, and provides South African bank deposit instructions",
  request: {
    body: {
...
registry.registerPath({
  ...
  description:
    "Creates off-ramp order, returns platform Solana deposit address, and records destination bank details",
  request: {
    body: {
...
registry.registerPath({
  ...
  description:
    "Triggers exchange conversion via VALR Simple Orders and initiates payout (Solana SPL USDC transfer or bank withdrawal)",
  parameters: [
    {
      name: "id",
      in: "path",
...
registry.registerPath({
  ...
  description:
    "Receives deposit notifications from VALR with HMAC-SHA512 signature verification to trigger automatic settlement",
  responses: {
    200: {
...
export function generateOpenApiSpec() {
  ...
  return generator.generateDocument({
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "Production REST API for USDC <-> ZAR On-Ramp and Off-Ramp on Solana powered by VALR exchange with 2% ABC Pay platform markup.",
    },
    servers: [{ url: "/" }],
  });
}