...
export function createApp(store) {
    ...
    app.post("/api/webhooks/didit", express.raw({ type: "application/json" }), handleDiditWebhook);
    app.post("/api/v1/webhooks/didit", express.raw({ type: "application/json" }), handleDiditWebhook);
