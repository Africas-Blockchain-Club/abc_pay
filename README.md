> **Setup guide:** The original main-branch README is preserved below. Its stack, paths, environment variables, and setup instructions describe the earlier architecture. For the current frontend/backend structure, use [Current project setup (addendum)](#current-project-setup-addendum). The original integration and regulatory descriptions are project context, not verification of implemented capabilities or regulatory status.
